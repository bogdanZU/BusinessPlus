$(document).ready(function() {  
    ...
    if(!$(this).hasClass('active')){
        $('.item-link').removeClass('active').siblings('.item-accordion').slideUp();
        $(this).addClass('active');
        $(this).siblings('.item-accordion').slideDown('faste');
    } else {
        $(this).removeClass('active').siblings('.item-accordion').slideUp();
    }
});
